...
def get_args():
    ...
    parser.add_argument('--image_list', type=str,
                        help="file with the file names of images", default="splits/eigen.txt")
    parser.add_argument('--H', type=int, 
                        help='height for the image.', default=192)
    parser.add_argument('--W', type=int, 
                        help='width for the image.', default=640)          
    parser.add_argument('--save_path', type=str,
                        help="folder for corrupted images", default="data_test/data")
    ...
    parser.add_argument('--severity_levels', nargs='+', type=int, help="Severity levels to be applied.", default=[1, 2, 3])
